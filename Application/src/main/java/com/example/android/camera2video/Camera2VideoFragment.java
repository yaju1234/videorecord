            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                switch (motionEvent.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        Toast.makeText(getActivity(),"Start recoding",Toast.LENGTH_LONG).show();
                        startRecordingVideo();
                        return true; // if you want to handle the touch event
                    case MotionEvent.ACTION_UP:
                        Toast.makeText(getActivity(),"Stop recoding",Toast.LENGTH_LONG).show();
                        if (mButtonVideo.getText().toString().trim().toLowerCase().equals("stop")) {
...
//        view.findViewById(R.id.info).setOnClickListener(this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.bt_show:
                startActivity(new Intent(getActivity(),ShowAllView.class));
                break;
//            case R.id.video: {
...
//                }
    ...
    private String getVideoFilePath1(Context context) {
...
// Stop recording
        ...
        if (null != activity) {
            ...
            new VideoCompressor().execute(mNextVideoAbsolutePath, getVideoFilePath1(getActivity()));
        }
    ...
    public void countDownTimer() {
        countDownTimer = new CountDownTimer(11000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                mTextField.setText("remaining: " + millisUntilFinished / 1000);
            }
